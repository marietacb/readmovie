...
const FEATURES = [
  ...
  { icon: Quote, title: "Diario personal", description: "Tus opiniones y citas de libros, más el registro de cine y series." },
        ...
        <div className="grid items-center gap-14 md:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#modulos" className="bj-btn-secondary">Ver módulos</a>
            </div>
          </div>
          <BookshelfHero />
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Link href="/movies" className="bj-panel group overflow-hidden p-8 transition-all hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="mt-2 text-sm text-bj-muted">Colección, reseñas, visionados por día y calendario.</p>
              <span className="mt-5 inline-block text-sm font-semibold text-bj-terracotta group-hover:underline">
            ...
            <Link href="/series" className="bj-panel group overflow-hidden p-8 transition-all hover:-translate-y-1 hover:shadow-lg md:col-span-2 lg:col-span-1">
              ...
              <p className="mt-2 text-sm text-bj-muted">Episodios por día, progreso, plataforma y reseñas.</p>
              <span className="mt-5 inline-block text-sm font-semibold text-bj-terracotta group-hover:underline">
